...
def test_evaluation_output_accuracy(tmp_dir, test_parquet, model_tar_gz):
    output_dir = os.path.join(tmp_dir, "processing/evaluation")
    evaluate_output_accuracy(model_path=model_tar_gz, test_path=test_parquet, output_dir=output_dir, extract_path=tmp_dir)
